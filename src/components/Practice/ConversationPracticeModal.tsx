                ...
                <div className="space-y-2 pt-4">
                  {genderedPhrases.map((phrase, index) => (
                    <button
                      ...
                      className="w-full text-left p-5 sm:p-6 rounded-3xl border-2 border-border hover:border-primary/50 bg-card transition-all hover:shadow-md active:scale-[0.98]"
                    >
