      ...
      >
        <defs>
          <linearGradient id="cloud1-gradient" x1="92.5" y1="0" x2="92.5" y2="273" gradientUnits="userSpaceOnUse">
            <stop stopColor="#DFE9FF" stopOpacity="0.4"/>
            <stop offset="1" stopColor="#EEF4FF" stopOpacity="0.6"/>
          </linearGradient>
        </defs>
      ...
      >
        <defs>
          <linearGradient id="cloud2-gradient" x1="1173" y1="0" x2="1173" y2="278" gradientUnits="userSpaceOnUse">
            <stop stopColor="#E8EFFF" stopOpacity="0.5"/>
            <stop offset="1" stopColor="#F2F6FF" stopOpacity="0.7"/>
          </linearGradient>
        </defs>
      ...
      >
        <defs>
          <linearGradient id="cloud3-gradient" x1="204.812" y1="0" x2="204.812" y2="238" gradientUnits="userSpaceOnUse">
            <stop stopColor="#E3ECFF" stopOpacity="0.45"/>
            <stop offset="1" stopColor="#F0F5FF" stopOpacity="0.65"/>
          </linearGradient>
        </defs>
