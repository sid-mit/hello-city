...
export const CloudBackground = () => {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none">
      ...
      <motion.svg
        className="absolute"
        style={{ left: '-107px', bottom: 0, width: '578px', height: '273px' }}
      ...
      >
        <defs>
          <linearGradient id="cloud1-gradient" x1="92.5" y1="0" x2="92.5" y2="273" gradientUnits="userSpaceOnUse">
            <stop stopColor="#DFE9FF" stopOpacity="0.85"/>
            <stop offset="1" stopColor="#EEF4FF" stopOpacity="0.95"/>
          </linearGradient>
        </defs>
      ...
      <motion.svg
        className="absolute"
        style={{ right: '-50px', top: 0, width: '584px', height: '278px' }}
      ...
      >
        <defs>
          <linearGradient id="cloud2-gradient" x1="1173" y1="0" x2="1173" y2="278" gradientUnits="userSpaceOnUse">
            <stop stopColor="#E8EFFF" stopOpacity="0.85"/>
            <stop offset="1" stopColor="#F2F6FF" stopOpacity="0.95"/>
          </linearGradient>
        </defs>
      ...
      <motion.svg
        className="absolute"
        style={{ left: '291px', top: '112px', width: '445px', height: '238px' }}
      ...
      >
        <defs>
          <linearGradient id="cloud3-gradient" x1="204.812" y1="0" x2="204.812" y2="238" gradientUnits="userSpaceOnUse">
            <stop stopColor="#E3ECFF" stopOpacity="0.85"/>
            <stop offset="1" stopColor="#F0F5FF" stopOpacity="0.95"/>
          </linearGradient>
        </defs>
