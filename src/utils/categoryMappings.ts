...
export const SITUATION_METADATA: Record<string, SituationMetadata> = {
  ...
  dietary: {
    id: 'dietary',
    title: 'Dietary Needs',
    description: 'Communicate food requirements',
    emoji: '🍴',
  ...
  facilities: {
    id: 'facilities',
    title: 'Facilities',
    description: 'Find services and amenities',
    emoji: '🏢',
    context: 'Looking for facilities',
  },
  'finding facilities': {
    id: 'finding facilities',
    title: 'Finding Facilities',
    description: 'Locate services',
    emoji: '🚻',
    context: 'Looking for amenities',
  },
  getting_in: {
    id: 'getting_in',
    title: 'Getting In',
    description: 'Enter and get started',
    emoji: '🚪',
    context: 'At the entrance',
  },
  help: {
    id: 'help',
    title: 'Getting Help',
    ...
    emoji: '🆘',
    context: 'When you need support',
  },
  info: {
    id: 'info',
    title: 'Information',
    description: 'Get details and facts',
    emoji: 'ℹ️',
    context: 'Making inquiries',
  },
  medicine: {
  ...
  price: {
    id: 'price',
    title: 'Asking Price',
    description: 'Inquire about costs',
    emoji: '💵',
  ...
  reading_map: {
    id: 'reading_map',
    title: 'Reading Map',
    description: 'Navigate with directions',
    emoji: '🗺️',
    context: 'Finding your way',
  },
  reporting: {
    id: 'reporting',
    title: 'Reporting',
  ...
  symptoms: {
    ...
    description: 'Explain how you feel',
    emoji: '🤒',
