          ...
          serverResponses: [
            {
              afterUserPhraseIndex: 0,
              native: '这是去故宫的地铁。',
              romanization: 'zhè shì qù gù gōng de dì tiě',
              english: 'This is the subway to the Forbidden City.',
            },
            {
              afterUserPhraseIndex: 1,
              native: '需要6元人民币。',
              romanization: 'xū yào liù yuán rén mín bì',
              english: '6 RMB required.',
            },
            {
              afterUserPhraseIndex: 2,
              native: '如果你去故宫的话，不需要换乘。',
              romanization: 'rú guǒ nǐ qù gù gōng de huà, bù xū yào huàn chéng',
              english: "If you go to the Forbidden City, you don't need to change trains.",
            },
          ],
          conversationFlow: [
            { step: 1, speaker: 'you', phraseIndex: 0 },
            { step: 2, speaker: 'other', action: 'Metro staff responds about the destination' },
            { step: 3, speaker: 'you', phraseIndex: 1 },
            { step: 4, speaker: 'other', action: 'Metro staff explains the fare' },
            { step: 5, speaker: 'you', phraseIndex: 2 },
            { step: 6, speaker: 'other', action: 'Metro staff confirms the route' },
          ],
          culturalTip: 'Beijing metro uses a distance-based fare system. Keep your ticket until you exit.',
        },
      ],
    },
    {
